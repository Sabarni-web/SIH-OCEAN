...
export declare const fetchLiveIncoisArgoFloats: (startDate?: string, endDate?: string) => Promise<ArgoFloat[]>;
export declare const fetchAllIncoisObservations: (startDate?: string, endDate?: string) => Promise<Observation[]>;
