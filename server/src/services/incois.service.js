...
const fetchLiveIncoisArgoFloats = async (startDate, endDate) => {
    try {
...
const fetchAllIncoisObservations = async (startDate, endDate) => {
    ...
    const liveArgoFloats = await (0, exports.fetchLiveIncoisArgoFloats)(startDate, endDate);
