...
exports.fetchFloatDepthProfile = exports.fetchAllIncoisObservations = exports.fetchLiveIncoisArgoFloats = exports.INCOIS_BGC_FLOATS = exports.INCOIS_CTD_STATIONS = exports.INCOIS_GLIDERS = exports.INCOIS_MOORED_BUOYS = exports.getArgoDatasetId = exports.getErddapBaseUrl = void 0;
...
const getErddapBaseUrl = () => (process.env.INCOIS_ERDDAP_URL || 'https://erddap.incois.gov.in/erddap').replace(/\/$/, '');
exports.getErddapBaseUrl = getErddapBaseUrl;
const getArgoDatasetId = () => process.env.INCOIS_ARGO_DATASET_ID || 'Indian_ARGO_Floats';
exports.getArgoDatasetId = getArgoDatasetId;
// 1. Operational Indian Ocean Moored Buoy Array (OOS & RAMA Network)
exports.INCOIS_MOORED_BUOYS = [
    {
...
const fetchLiveIncoisArgoFloats = async (startDate, endDate, bounds) => {
    ...
    byFloat.forEach((cycleRows, wmoId) => {
        ...
        selectedCycles.forEach((row, cIdx) => {
...
exports.fetchLiveIncoisArgoFloats = fetchLiveIncoisArgoFloats;
const fetchAllIncoisObservations = async (startDate, endDate, bounds, typeFilter) => {
    ...
    if (!typeFilter || typeFilter === 'argo') {
        liveArgoFloats = await (0, exports.fetchLiveIncoisArgoFloats)(startDate, endDate, bounds);
    }
    ...
    if (bounds) {
        combined = combined.filter(obs => obs.latitude >= bounds.minLat && obs.latitude <= bounds.maxLat &&
...
exports.fetchAllIncoisObservations = fetchAllIncoisObservations;
const fetchFloatDepthProfile = async (wmoId) => {
    try {
        const baseUrl = (0, exports.getErddapBaseUrl)();
        const datasetId = (0, exports.getArgoDatasetId)();
...
exports.fetchFloatDepthProfile = fetchFloatDepthProfile;
//# sourceMappingURL=incois.service.js.map