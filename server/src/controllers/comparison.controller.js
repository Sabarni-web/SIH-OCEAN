...
exports.getComparisonProfile = void 0;
const zod_1 = require("zod");
const getComparisonProfile = (req, res) => {
    const schema = zod_1.z.object({
        modelDataset: zod_1.z.string(),
    ...
    for (let i = 0; i < depths.length; i++) {
        ...
        if (variable === 'temperature')
            obsVal = 28 - (d / 2000) * 25 + Math.random();
...
exports.getComparisonProfile = getComparisonProfile;
